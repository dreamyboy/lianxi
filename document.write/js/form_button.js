...
var url='web.htm';
document.write("<table align=center><tr><td><button style='background:#7DC4C6;color: #FFFFFF;cursor: pointer;border:0;font-size: 14px;height: 30px;text-align: center;width: 90px;' type=button onclick=Imad_Set('block') onfocus=this.blur()>点击</button></td></tr></table>");
